  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-11/12 md:w-4/5 lg:w-3/5 bg-white shadow-lg rounded-2xl flex justify-between items-center p-4 z-50">
      ...
      <div className="hidden md:flex gap-6 font-semibold text-black">
        <Link href="https://stanlyegypt.com/?v=890e1209a1dd">Home</Link>
        <Link href="https://stanlyegypt.com/about/?v=890e1209a1dd">About</Link>
      </div>
      ...
      {/* Right Links */}
      <div className="hidden md:flex gap-6 font-semibold text-black">
        <Link href="https://stanlyegypt.com/trips/?v=890e1209a1dd">Trips</Link>
        <Link href="https://stanlyegypt.com/contact-us/?v=890e1209a1dd">
          Contact Us
        </Link>
      </div>
